...
# Variável tamanho da tela
canvas = Canvas(root, width=900, height=700, bd=0,highlightthickness=0)
canvas.pack()

# Concatenação de root
root.update()
...
class Barra:
    ...
    def move_right(self, event):
        if self.pos[0] <= self.canvas_width:
            self.x = 3
